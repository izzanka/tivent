                    ...
                    <tbody>
                        @forelse ($orders as $order)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('order.admin.confirm',[$order->id,"success"]) }}" class="btn btn-sm btn-success">Confirm</a><br>
                                    <a href="{{ route('order.admin.confirm',[$order->id,"failed"]) }}" class="btn btn-sm btn-danger mt-2">Confirm Failed</a>
                                </td>
                            </tr>
                        @empty
