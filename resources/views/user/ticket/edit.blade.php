...
<div class="container">
    ...
    <form method="post" action="{{ route('ticket.update',['event' => $event->id,'ticket' => $ticket->id]) }}">
        @csrf
        <div class="row">
            <div class="col-md-6">
                    ...
                    <div class="col">
                        <table class="table" style="border-top : hidden">
                            ...
                            <tr>
                                ...
                                <td>
                                <div class="form-group">
                                    <input type="number" class="form-control @error('price') is-invalid @enderror" name="price" placeholder="Rp." min="0" value="{{ $ticket->price}}">
                                    @error('price')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <tr>
                                ...
                                <td>
                                <div class="form-group">
                                    <input type="number" class="form-control @error('amount') is-invalid @enderror" name="amount"  min="1" value="{{ $ticket->amount}}">
                                    @error('amount')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <tr>    
                                <td colspan="3">
                                    <button type="submit" class="btn btn-dark btn-block">Edit Ticket</button>
                                </td>
                            </tr>
                        </table>
                        </form>
